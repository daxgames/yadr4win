...
:CLINK_FINISH
  if not defined GIT_INSTALL_ROOT set "GIT_INSTALL_ROOT=C:\Users\vagrant\cmderdev\vendor\git-for-windows"
  if not defined SVN_SSH          set "SVN_SSH=C:\\Users\\vagrant\\cmderdev\\vendor\\git-for-windows\\bin\\ssh.exe"
  if not defined git_locale       set git_locale="C:\Users\vagrant\cmderdev\vendor\git-for-windows\usr\bin\locale.exe"
  if not defined LANG             set LANG=en_US.UTF-8
  if not defined user_aliases     set "user_aliases=C:\Users\vagrant\cmderdev\config\user_aliases.cmd"
